...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        if ($action === 'approve_vendor') {
            ...
            header('Location: ../../client/admin_dashboard.php?tab=pendings&success=1'); exit;
            ...
            header('Location: ../../client/admin_dashboard.php?tab=vendors&success=1'); exit;
        } elseif ($action === 'delete_donor') {
            $donor_id = $_POST['donor_id'];
            $pdo->prepare("DELETE FROM donors WHERE id=?")->execute([$donor_id]);
            header('Location: ../../client/admin_dashboard.php?tab=donors&success=1'); exit;
            ...
            header('Location: ../../client/admin_dashboard.php?tab=health&success=1'); exit;
        }
